...
$header2[] = 'Cookie:Hm_lvt_7aebe0b385821389d2e1aad80fc6b32b=1676881594; Hm_lpvt_7aebe0b385821389d2e1aad80fc6b32b=1676881594; USERSESSIONID=5mulh3l0qbpf7u2jv8mp51gc71; loginUsername=fayCnuum4IaR1unBfHwtYg%3D%3D';
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://kf.quicksdk.com/file/fupload/r/iconFiles');
...
echo 'http://kf.quicksdk.com'.$JsonData['save_path'];
}
